...
export function render() {
	...
	oscillators[0].spread = Math.max(100*12*7 * channels[1] / 128.0, oscillatorInitialSpread)
	oscillators[1].spread = Math.max(100*12*7 * channels[2] / 128.0, oscillatorInitialSpread)
	
	if(time % 1.0 > 0.9) {
		console.log(oscillators[0].spread)
	}

	filter3.Q.value = Math.pow(10, -3.0 + 5.0 * channels[3] / 128.0)
